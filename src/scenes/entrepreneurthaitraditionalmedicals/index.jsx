...
const Entrepreneurthaitraditionalmedicals = () => {
    ...
    const { result, isFetching } = useSelector((state) => state.app.entrepreneurthaitraditionalmedicalReducer)
...
export default Entrepreneurthaitraditionalmedicals