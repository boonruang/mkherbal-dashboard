            ...
            <Header title="ข้อมูลแผนที่" subtitle="แหล่งขาย" />
              <Box  display="flex" justifyContent="space-between" component="form" 
                    ...
                    >
                      ...
                      <MenuItem value={1} defaultChecked>1</MenuItem>
                    ...
                    {/* <Button variant="contained" color="secondary" onClick={() => dispatch(wrapTo("mkplc",(toggleSplitMap)))}>
                      Toggle Split Map
                    </Button>  

                    <Button variant="contained" color="secondary" onClick={() => dispatch(wrapTo("mkplc",(togglePerspective)))}>
                      Toggle Perspective
                    </Button>  */}                                     

                    {/* <Button variant="contained" color="secondary" onClick={() => dispatch(wrapTo('mkplc',toggleMapLegend())) }>
                      Toggle Map Legend
                    </Button> */}
